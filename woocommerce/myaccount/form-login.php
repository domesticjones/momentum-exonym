...
<?php endif; ?>
    <?php echo ex_wrap('start', 'fullwidth'); ?>
    <div class="module-inner">
  		<h1 class="login-header"><span>Your Account</span><?php esc_html_e( 'Login to Schedule', 'woocommerce' ); ?></h1>
  		...
  		<form class="woocommerce-form woocommerce-form-login login" method="post">
  			...
  			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
  				<label for="username"><?php esc_html_e( 'Your Email Address', 'woocommerce' ); ?></label>
